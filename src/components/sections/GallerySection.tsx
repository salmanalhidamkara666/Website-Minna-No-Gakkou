...
export default function GallerySection() {
  ...
  const categories = ['Semua', 'Kegiatan Belajar', 'Kelas Bahasa Jepang', 'Simulasi Kaigo', 'Alumni', 'Event', 'Jepang'];
  ...
  const galleryItems: GalleryItem[] = [
    ...
    },
    {
      ...
      imgUrl: 'https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?q=80&w=600&auto=format&fit=crop'
    },
    {
      id: 5,
      category: 'Event',
    ...
    },
    {
      ...
      imgUrl: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?q=80&w=600&auto=format&fit=crop'
    },
    {
      id: 7,
      category: 'Kelas Bahasa Jepang',
      title: 'Latihan Kaiwa dengan Native Speaker',
      imgUrl: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=600&auto=format&fit=crop'
    },
    {
      id: 8,
      category: 'Simulasi Kaigo',
      title: 'Praktik Komunikasi Terapeutik',
      imgUrl: 'https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?q=80&w=600&auto=format&fit=crop'
    }
  ];
    ...
    <section id="gallery" className="py-24 bg-white scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Galeri Kegiatan</h2>
          <div className="w-20 h-1.5 bg-primary mx-auto rounded-full mb-6"></div>
          <p className="text-lg text-gray-600">
            Aktivitas harian, kelas pelatihan, suasana simulasi, hingga momen-momen keberangkatan alumni kami ke Jepang.
          </p>
        </div>
            ...
            {filteredItems.map((item) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-5">
                  <span className="text-xs text-accent-gold font-semibold uppercase tracking-wider mb-1">{item.category}</span>
                  <h4 className="text-white font-bold text-sm leading-tight mb-2">{item.title}</h4>
              ...
              >
                <div className="overflow-y-auto flex-1 flex flex-col">
                  ...
                  <div className="p-6 bg-white shrink-0">
                    <span className="text-xs text-primary font-bold uppercase tracking-wider mb-1 block">{selectedItem.category}</span>
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 leading-snug">{selectedItem.title}</h3>
