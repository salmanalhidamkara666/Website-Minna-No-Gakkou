...
import { Mail, MapPin, Phone, Clock, Compass, ExternalLink } from 'lucide-react';

export default function ContactSection() {
  const mapUrl = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15830.088190772242!2d106.586111!3d-7.300556!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4d106.586111!3d-7.300556!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e680c44ec93e7f9%3A0xe6bf4462cb3e42ea!2sCinagen%2C%20Surade%2C%20Jampangkulon%2C%20Sukabumi%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1700000000000!5m2!1sid!2sid";
  const externalMapLink = "https://maps.google.com/?q=Cinagen,+Surade,+Jampangkulon,+Sukabumi,+Jawa+Barat";
    ...
    <section id="kontak" className="py-24 bg-neutral-gray scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-sans tracking-tight">Kontak & Lokasi Lembaga</h2>
          <div className="w-20 h-1.5 bg-primary mx-auto rounded-full mb-6"></div>
          <p className="text-lg text-gray-600">
            Kunjungi kampus kami atau hubungi tim administrasi untuk konsultasi langsung program pelatihan.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-6">
              ...
              {contacts.map((contact, idx) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed font-medium">{contact.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="bg-primary-dark text-white p-6 rounded-2xl flex flex-col gap-4 border border-primary-light/10">
              ...
              <p className="text-sm text-primary-light/80">Dapatkan rute langsung menuju kampus dari lokasi Anda melalui aplikasi navigasi.</p>
