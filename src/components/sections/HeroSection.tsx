        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-[1.15] tracking-tight mb-6">
              Belajar Bahasa Jepang dan Raih Karir Impian di <span className="text-primary italic">Jepang</span>.
            </h1>
            
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              LPK Minna No Gakkou hadir untuk membantu generasi muda Indonesia menguasai Bahasa Jepang dan mempersiapkan diri bekerja di Jepang secara profesional, legal, dan terpercaya.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-8 border-t border-gray-200/60">
              <div>
                ...
                <p className="text-sm font-medium text-gray-500">Alumni Sukses</p>
              </div>
              <div>
                <h4 className="text-3xl font-bold text-gray-900 mb-1">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-500">Thn Pengalaman</p>
              </div>
              <div>
                <h4 className="text-3xl font-bold text-gray-900 mb-1 flex items-center">
                  95%
                </h4>
                <p className="text-sm font-medium text-gray-500">Tk. Kelulusan</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative rounded-[2rem] overflow-hidden aspect-[4/5] sm:aspect-square lg:aspect-[4/5] bg-gradient-to-br from-primary-light to-white border-2 border-white shadow-2xl">
              ...
              >
                ...
                <div>
                  <p className="text-xs text-gray-500 font-medium">SSW & Kaigo</p>
                  <p className="text-sm font-bold text-gray-900">Kurikulum Valid</p>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="flex -space-x-3">
                    <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=120&auto=format&fit=crop" alt="Alumni" className="w-10 h-10 rounded-full border-2 border-white object-cover" />
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=120&auto=format&fit=crop" alt="Alumni" className="w-10 h-10 rounded-full border-2 border-white object-cover" />
                    <img src="https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?q=80&w=120&auto=format&fit=crop" alt="Alumni" className="w-10 h-10 rounded-full border-2 border-white object-cover" />
                  </div>
                  <div>
                    <p className="text-sm font-bold text-gray-900">500+ Bekerja</p>
