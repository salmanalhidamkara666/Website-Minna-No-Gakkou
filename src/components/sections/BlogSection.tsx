...
import { BookOpen, Calendar, ChevronRight, User, X, Filter } from 'lucide-react';
...
export default function BlogSection() {
  ...
  const categories = ["Semua", "Tokutei Ginou", "Kaigo", "Bahasa Jepang", "Budaya Jepang", "Persiapan Ujian", "Tips Wawancara", "Alumni Sukses"];
  ...
  const articles: Article[] = [
    ...
    },
    {
      ...
      title: "Mengenal JLPT dan JFT-Basic: Ujian Mana yang Sebaiknya Anda Ambil?",
      excerpt: "Ketahui perbedaan materi uji, format komputerisasi, dan tingkat kemudahan kelulusan bagi pendaftar visa Tokutei Ginou.",
      content: "Untuk mendaftar program Pekerja Berketerampilan Khusus (SSW), syarat wajibnya adalah lulus sertifikasi bahasa Jepang level A2 / N4. Anda diberikan dua pilihan ujian resmi:\n\n1. JFT-Basic (Japan Foundation Test):\n   - Diselenggarakan dengan komputer (CBT) beberapa kali dalam setahun.\n   - Hasil langsung diketahui dalam beberapa hari, sangat ramah bagi yang butuh sertifikasi cepat.\n   - Fokus pada percakapan berbasis situasi nyata sehari-hari.\n\n2. JLPT (Japanese Language Proficiency Test):\n   - Diselenggarakan luring manual 2 kali setahun (Juli & Desember).\n   - Merupakan tes standar global paling bergengsi namun memiliki waktu rilis sertifikat lebih lama.\n\nSaran kami: Ambil JFT-Basic jika Anda berniat segera melamar lowongan kerja secepatnya.",
      date: "20 Mei 2026",
      author: "Sensei Gakkou",
      imgUrl: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?q=80&w=600&auto=format&fit=crop"
    },
    {
      id: 8,
      category: "Alumni Sukses",
      title: "Kisah Sukses Budi: Dari LPK Minna No Gakkou Hingga Menjadi Caregiver di Kyoto",
      excerpt: "Perjalanan luar biasa alumni kami yang kini berpenghasilan puluhan juta rupiah dan mendapatkan pujian dari institusi lansia Kyoto.",
      content: "Budi, pemuda asal daerah yang berbekal keyakinan tinggi, memutuskan mendaftar kelas persiapan intensif di LPK Minna No Gakkou. Dalam kurun waktu 5 bulan belajar, dia berhasil menyabet sertifikat N4 dan lulus Ujian Kompetensi Kaigo.\n\nKini, Budi telah bekerja selama hampir setahun di Shishikura Senior Care Facility di Kyoto. Dengan keramahan khas Indonesia dikombinasikan kepatuhan SOP Jepang, dia diakui sebagai salah satu karyawan asing teladan. 'LPK mendidik saya tidak cuma bahasa, tetapi mental baja bertahan hidup di luar negeri,' tutur Budi melalui panggilan video alumni.",
      date: "15 Mei 2026",
      author: "Admin LPK",
      imgUrl: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=600&auto=format&fit=crop"
    },
    {
      id: 9,
      category: "Kaigo",
      title: "Biaya Hidup dan Estimasi Tabungan Bekerja Sebagai Perawat di Tokyo",
      excerpt: "Mari bedah rincian pengeluaran tempat tinggal, pajak kesejahteraan, konsumsi makan bulanan, dan sisa tabungan bersih yang bisa dikirim ke keluarga.",
      content: "Berapakah sisa bersih gaji perawat lansia di Tokyo setelah dipotong aneka pengeluaran wajib? Tokyo merupakan kota metropolitan dengan upah dasar tertinggi, namun biaya hidupnya juga perlu kalkulasi cermat.\n\nBerikut simulasi rata-rata pengeluaran bulanan:\n- Gaji Kotor: 210.000 Yen\n- Pajak Pendapatan & Asuransi Kesehatan: 35.000 Yen\n- Biaya Apartemen Subsidi/Asrama LPK: 25.000 Yen\n- Makan & Transport: 40.000 Yen\n- Utilitas (Listrik, Gas, Air, Internet): 15.000 Yen\n\nTotal Pengeluaran: 115.000 Yen.\nSisa Tabungan Bersih: ~95.000 Yen (setara Rp 9,8 - 10 juta rupiah per bulan) yang siap ditabung penuh oleh pekerja.",
      date: "10 Mei 2026",
      author: "Sensei Ramdani",
      imgUrl: "https://images.unsplash.com/photo-1524593689594-aae2f26b75ab?q=80&w=600&auto=format&fit=crop"
    },
    {
      id: 10,
      category: "Bahasa Jepang",
      title: "Pentingnya Menguasai 'Aisatsu' (Salam) Sebelum Memasuki Dunia Kerja Jepang",
      excerpt: "Pelajari cara berucap selamat pagi, ucapan minta tolong, hingga ungkapan kelelahan kerja bersama rekan profesional lainnya.",
      content: "Aisatsu (salam) adalah tiang utama sopan santun komunikasi sosial di negara Jepang. Mengucapkan salam secara lantang di saat pagi hari, sebelum makan, dan sebelum pulang kerja dipandang mencerminkan kepedulian tulus terhadap iklim kerja positif.\n\nTiga Aisatsu krusial di tempat kerja:\n- 'Ohayou Gozaimasu': Salam pagi hari yang penuh energi positif.\n- 'Otsukaresama Deshita': Diucapkan kepada rekan kerja saat mengakhiri sif kerja atas kerja keras bersama.\n- 'Shitsurei Shimasu': Diucapkan saat memasuki ruangan pimpinan atau mendahului pulang dari rekan lainnya.",
      date: "05 Mei 2026",
      author: "Sensei Maya",
  ...
  return (
    <section id="artikel" className="py-24 bg-white scroll-mt-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4 font-sans tracking-tight">Kandungan Artikel & Informasi Terkini</h2>
          <div className="w-20 h-1.5 bg-primary mx-auto rounded-full mb-6"></div>
          <p className="text-lg text-gray-600 leading-relaxed font-medium">
            Ketahui edukasi seputar kebahasaan, regulasi pemerintah, kebudayaan Jepang, hingga cerita inspiratif alumni kami.
          </p>
        </div>
        ...
        {filteredArticles.length === 0 ? (
          <div className="text-center py-20 bg-gray-50 rounded-[2rem] border border-gray-100 max-w-xl mx-auto">
            ...
            <p className="text-gray-500 font-bold">Belum ada artikel untuk kategori ini.</p>
            <button 
