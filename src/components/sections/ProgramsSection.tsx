  ...
  const programs = [
    {
      ...
      items: ["Hiragana & Katakana", "Kanji Dasar & Lanjut", "Kaiwa (Percakapan)", "JLPT N5 - N1"]
    },
    {
      title: "Program Kaigo",
      icon: <HeartHandshake className="w-8 h-8" />,
      desc: "Pelatihan khusus perawat lansia dengan standar operasional dan etika pelayanan panti jompo di Jepang.",
      items: ["Dasar Kaigo", "Simulasi Kerja", "SOP Kaigo Jepang", "Budaya Kerja Jepang", "Persiapan Interview"]
    },
    {
      ...
      items: ["Pengolahan Makanan", "Pertanian & Perhotelan", "Manufaktur & Perikanan", "Simulasi & Etika Kerja"]
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            Kurikulum terstruktur dan aplikatif yang dirancang khusus untuk memenuhi standar kualifikasi bekerja di Jepang.
          </p>
        </div>
            ...
            >
              ...
              <ul className="space-y-3 pt-6 border-t border-gray-100">
                {program.items.map((item, idxi) => (
                  <li key={idxi} className="flex items-center gap-3 text-sm font-medium text-gray-700">
