...
export default function Header() {
  ...
  const menuItems = ['Beranda', 'Tentang Kami', 'Program', 'Gallery', 'Artikel', 'Testimoni', 'FAQ', 'Kontak'];
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-primary-dark font-semibold font-mono">みんなの学校</p>
            </div>
          </div>
