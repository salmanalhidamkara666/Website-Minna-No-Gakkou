          ...
          >
            <div className="bg-primary p-4 text-white flex justify-between items-center">
              <div>
                ...
                <p className="text-xs text-primary-light/80">Pilih admin sesuai kebutuhan</p>
              </div>
            ...
            <div className="p-4 flex flex-col gap-3">
              <a
                href={getWaLink('6285536601150', 'Halo Admin Minna No Gakkou, saya ingin mendapatkan informasi mengenai program pelatihan kerja ke Jepang.')}
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                <div>
                  <h5 className="font-semibold text-sm text-gray-900">Admin Pendaftaran</h5>
                  <p className="text-xs text-gray-500">Info Program & Kuota</p>
                </div>
              </a>

              <a
                href={getWaLink('6285781124502', 'Halo Admin Minna No Gakkou, saya ingin berkonsultasi mengenai program bahasa Jepang dan peluang kerja ke Jepang.')}
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-3 p-3 rounded-xl hover:bg-primary-light/50 transition-colors border border-gray-100"
              >
                ...
                <div>
                  <h5 className="font-semibold text-sm text-gray-900">Admin Konsultasi</h5>
